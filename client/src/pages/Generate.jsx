        ...
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-lg font-semibold">
              Creator<span className="text-zinc-400">.AI</span>
            </h1>
          </div>
        </div>
      </div>
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        >
          ...
          <p className="text-zinc-400 max-w-2xl mx-auto">
            This process may take several minutes. creator.ai focuses on
            quality, not shorcuts.
          </p>
        </motion.div>
        <div className="mb-14">
          ...
          <div className="relative mb-10">
            <textarea
              ...
              className="w-full h-56 p-6 rounded-3xl bg-black/60 border-white/10 border outline-none resize-none text-sm leading-relaxed focus:ring-2 focus:ring-white/20 "
            ></textarea>
          </div>
          ...
          {loading && (
            <motion.div 
            initial={{opacity: 0}} animate={{opacity:1}} className="max-w-xl mx-auto mt-12">
                <div className="flex justify-between mb-2 text-xs text-zinc-400">
                    <span>{Phases[phaseIndex]}</span>
                    <span>{progress}%</span>
                </div>
                <div className="h-2 w-full bg-white/10 rounded-full overflow-hidden">
                    <motion.div className="h-full bg-linear-to-r from-white to-zinc-300" initial={{width:'0%'}} animate={{width: `${progress}%`}} transition={{ease: "easeOut", duration: 0.8}}/>
                </div>
